...
| 4. Weekly landlord report | Complete | app + mock Outlook activity, external-only report, scoped Korean command patch | Persistent schema-v3 report state; five allowlisted Korean investigations; strict Zod/source/building validation; scoped accept/reject; configured To/Cc; LM Manager approval; exactly-once sandbox delivery/activity; stale source/recipient/material blocking; curated Mobile adapter; responsive Admin/Mobile workspaces verified at 375/768/1280 |
